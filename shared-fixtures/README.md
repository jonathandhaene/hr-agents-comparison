...
| `competency_framework.json` | UC7 fine-tuning | Zava competency descriptors per grade level (L3–L7) — used as system-prompt grounding for the fine-tuned narrative model |
